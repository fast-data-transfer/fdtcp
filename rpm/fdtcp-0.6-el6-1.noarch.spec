...
Provides:      config(fdtcp) = 0.6.1
Provides:      fdtcp = 0.6.1
Requires:      /bin/sh
Requires:      /usr/bin/env
Requires:      cog-jglobus
Requires:      config(fdtcp) = 0.6.1
Requires:      fdt
Requires:      openjdk
...
%attr(0755, root, root) "/usr/bin/wrapper_auth.sh"
...
%dir "/usr/share/doc/fdtcp-0.6"
%doc %attr(0644, root, root) "/usr/share/doc/fdtcp-0.6/README"
%dir "/usr/share/java/fdtcp"
"/usr/share/java/fdtcp/authclient.jar"
"/usr/share/java/fdtcp/authservice.jar"
